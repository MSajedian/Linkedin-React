						...
						<Card>
							<Card.Body>
								...
								>
									...
									<label for="input-picture" className="btn btn-primary mx-2 bg-white text-dark border-0">
										<svg
											xmlns="http://www.w3.org/2000/svg"
											width="24"
											height="24"
									...
									}} style={{ display: 'none' }} type="file" id="input-picture" />
						...
						<Card>
							<Col xs={12} className="p-0 mb-4 section-outer">
								...
								>
									<img
										style={{ width: "48px", height: "48px" }}
										src="https://media-exp1.licdn.com/dms/image/C4D0BAQF2N4oLrjT9uQ/company-logo_200_200/0/1607100764613?e=1628726400&v=beta&t=-ym0gdwneMH_gEiNV96nA4QASLign5VOBrEyAh9LBQ4"
										alt=""
									></img>

									<div className="ms-2 d-flex flex-column">
										<span>LinkedIn News UK</span>
										<span className="text-muted">863,439 followers</span>
								...
								<div style={{ padding: "12px 12px 0px 12px" }}>
									<img
										...
										alt="LIKE"
									></img>
									<span className="text-muted"> 69 · 0 comments </span>
								</div>
